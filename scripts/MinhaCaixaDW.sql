...
--USE master
--go
--IF EXISTS (SELECT * FROM SYS.databases WHERE NAME = 'MinhaCaixaDW')
--ALTER DATABASE MinhaCaixaDW SET SINGLE_USER WITH ROLLBACK IMMEDIATE
--IF EXISTS (SELECT * FROM SYS.databases WHERE NAME = 'MinhaCaixaDW')
--DROP database MinhaCaixaDW
--go
--CREATE DATABASE MinhaCaixaDW
--GO
--USE MinhaCaixaDW
--GO
--CREATE SCHEMA Dim
...
-- Initial values
SELECT @StartingDate  = '2010-01-01 00:00:00.000'
SELECT @EndingDate = '2018-12-31 00:00:00.000'
